...
//     version 1.20.0
//     from Assets/Settings/Input Asset/InputSystem_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Input Asset/InputSystem_Actions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Exit"",
                    ""type"": ""Button"",
                    ""id"": ""5a4cf85e-368a-4cf9-ba3a-4658956aee4d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false,
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""e19bd1d2-c27c-45ee-826f-ee43e024cc98"",
        ...
        {
            ""name"": ""Voice"",
            ""id"": ""3ed795a1-1fde-42d5-940f-4f12b0a8643e"",
            ""actions"": [
                {
                    ""name"": ""PushToTalk"",
                    ""type"": ""Button"",
                    ""id"": ""ab1b3d5f-bafb-4db8-8950-d10e0c2e5542"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false,
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""288d8fb9-2149-436e-b5d9-fd3c5b700e47"",
                    ""path"": ""<Keyboard>/v"",
                    ""interactions"": """",
                    ""processors"": """",
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Voice.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Voice.Disable() has not been called.");
    }
    ...
    public struct VoiceActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public VoiceActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="VoiceActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="VoiceActions" />
        public void AddCallbacks(IVoiceActions instance)
        {
            if (instance == null || m_Wrapper.m_VoiceActionsCallbackInterfaces.Contains(instance)) return;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="VoiceActions.UnregisterCallbacks(IVoiceActions)" />.
        /// </summary>
        /// <seealso cref="VoiceActions.UnregisterCallbacks(IVoiceActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="VoiceActions.AddCallbacks(IVoiceActions)" />
        /// <seealso cref="VoiceActions.RemoveCallbacks(IVoiceActions)" />
        /// <seealso cref="VoiceActions.UnregisterCallbacks(IVoiceActions)" />
        public void SetCallbacks(IVoiceActions instance)
        {
            foreach (var item in m_Wrapper.m_VoiceActionsCallbackInterfaces)
                UnregisterCallbacks(item);
    ...
    /// <summary>
    /// Provides a new <see cref="VoiceActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Voice" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="VoiceActions.AddCallbacks(IVoiceActions)" />
    /// <seealso cref="VoiceActions.RemoveCallbacks(IVoiceActions)" />
